...
`).find(e=>{let t=e.trim();return t&&!t.startsWith(`#`)&&!t.startsWith(`:::`)&&!t.startsWith(`![`)&&!t.startsWith(`- `)&&!t.startsWith(`|`)&&!t.startsWith("```")})??``);return t.length>180?`${t.slice(0,177)}...`:t},O=e=>{let t=E(e.replace(/```[\s\S]*?```/g,``)).match(/[\u4e00-\u9fff]|[A-Za-z0-9]+/g)?.length??0;return Math.max(2,Math.round(t/320))},k=e=>new Intl.DateTimeFormat(`en`,{month:`short`,day:`numeric`,year:`numeric`}).format(new Date(`${e}T00:00:00Z`)),A=(e,t)=>{let n=e.split(`/`).pop()?.replace(/\.md$/,``);if(!n||n===`index`)return;let{meta:r,body:i}=T(t),a=i.replace(/^#\s+.+\n+/,``);return{slug:n,title:r.title||n,author:r.author||`Team Memoh`,date:k(n),excerpt:D(a),readingMinutes:O(a),body:a}},j=Object.entries(w).map(([e,t])=>A(e,t)).filter(e=>!!e).sort((e,t)=>t.slug.localeCompare(e.slug)),M=e=>j.find(t=>t.slug===e),N={class:`w-full max-w-[1080px] min-h-[calc(100vh-3.5rem)] mx-auto px-4 md:px-8 pt-[112px] md:pt-[148px] pb-[120px] relative z-10`},P={key:0,class:`flex flex-col gap-12`},F={class:`max-w-[760px] flex flex-col gap-5`},I={class:`inline-flex w-fit items-center gap-2 rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium text-muted-foreground`},L={class:`p-6 md:p-8 flex flex-col gap-6`},R={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground`},z={class:`inline-flex items-center gap-1.5`},B={class:`inline-flex items-center gap-1.5`},V={class:`inline-flex items-center gap-1.5`},H={class:`flex flex-col gap-3`},U={class:`text-2xl md:text-3xl font-semibold tracking-tight text-foreground leading-tight`},W={class:`text-sm md:text-base text-muted-foreground leading-relaxed`},G={class:`inline-flex items-center gap-2 text-sm font-medium text-foreground`},K={class:`grid grid-cols-1 md:grid-cols-2 gap-4`},q={class:`flex flex-col gap-4`},J={class:`flex items-center justify-between gap-3 text-xs text-muted-foreground`},Y={class:`flex flex-col gap-3`},ae={class:`text-lg font-semibold tracking-tight text-foreground leading-snug`},oe={class:`text-sm text-muted-foreground leading-relaxed`},se={class:`mt-8 inline-flex items-center gap-2 text-sm font-medium text-foreground`},ce={key:1,class:`mx-auto max-w-[820px]`},le={class:`mb-10 flex flex-col gap-5 border-b border-border pb-8`},ue={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground`},de={class:`inline-flex items-center gap-1.5`},fe={class:`inline-flex items-center gap-1.5`},pe={class:`inline-flex items-center gap-1.5`},me={class:`text-3xl md:text-5xl font-semibold tracking-tight text-foreground leading-tight`},he={class:`text-base md:text-lg text-muted-foreground leading-relaxed`},ge={key:0,class:`rounded-xl border border-border bg-background p-6 text-sm text-muted-foreground`},X=[`innerHTML`],_e={key:2,class:`mt-14 border-t border-border pt-8`},ve={class:`grid grid-cols-1 md:grid-cols-3 gap-4`},ye={class:`mb-2 text-xs text-muted-foreground`},be={class:`text-sm font-medium leading-snug text-foreground`},xe={key:2,class:`mx-auto flex max-w-[640px] flex-col items-center gap-5 py-24 text-center`},Se={class:`rounded-xl border border-border bg-muted p-3 text-muted-foreground`},Z=y(a({__name:`BlogsPage`,setup(a){let v=te(),y=ne(),w=s(()=>{let e=v.params.slug;return typeof e==`string`?e:``}),T=s(()=>w.value.length>0),E=s(()=>w.value?M(decodeURIComponent(w.value)):void 0),D=s(()=>j[0]),O=s(()=>j.filter(e=>e.slug!==E.value?.slug).slice(0,3)),k=n(``),A=n(!1),Z=0,Q=s(()=>E.value?`${E.value.title} | Memoh Blog`:T.value?`Post not found | Memoh Blog`:`Memoh Blog`),$=s(()=>E.value?.excerpt||`Field notes, architecture writeups, and product updates from the Memoh team.`);return ee({title:()=>Q.value,description:()=>$.value,ogTitle:()=>Q.value,ogDescription:()=>$.value,ogType:`article`,ogUrl:()=>`https://memoh.ai${v.path}`,twitterCard:`summary_large_image`,twitterTitle:()=>Q.value,twitterDescription:()=>$.value}),r(E,async e=>{let t=++Z;if(k.value=``,!e){A.value=!1;return}A.value=!0;let{renderMarkdown:n}=await re(async()=>{let{renderMarkdown:e}=await import(`./markdown-CY7Xcl62.js`);return{renderMarkdown:e}},[]),r=await n(e.body);t===Z&&(k.value=r,A.value=!1)},{immediate:!0}),(n,r)=>(i(),p(`main`,N,[T.value?E.value?(i(),p(`article`,ce,[f(o(_),{to:`/blogs`,class:`mb-8 inline-flex items-center gap-2 rounded-md px-0 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:h(()=>[f(o(ie),{class:`w-4 h-4`}),r[7]||=e(` Back to blogs `,-1)]),_:1}),d(`header`,le,[d(`div`,ue,[d(`span`,de,[f(o(b),{class:`w-3.5 h-3.5`}),e(` `+l(E.value.date),1)]),d(`span`,fe,[f(o(C),{class:`w-3.5 h-3.5`}),e(` `+l(E.value.author),1)]),d(`span`,pe,[f(o(x),{class:`w-3.5 h-3.5`}),e(` `+l(E.value.readingMinutes)+` min read `,1)])]),d(`h1`,me,l(E.value.title),1),d(`p`,he,l(E.value.excerpt),1)]),A.value?(i(),p(`div`,ge,` Rendering code blocks... `)):(i(),p(`div`,{key:1,class:`blog-body`,innerHTML:k.value},null,8,X)),O.value.length?(i(),p(`section`,_e,[r[8]||=d(`h2`,{class:`mb-4 text-lg font-semibold tracking-tight text-foreground`},`More from Memoh`,-1),d(`div`,ve,[(i(!0),p(u,null,t(O.value,e=>(i(),m(o(_),{key:e.slug,to:`/blogs/${e.slug}`,class:`group rounded-xl border border-border bg-background p-4 transition-all hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:h(()=>[d(`p`,ye,l(e.date),1),d(`h3`,be,l(e.title),1)]),_:2},1032,[`to`]))),128))])])):c(``,!0)])):(i(),p(`section`,xe,[d(`div`,Se,[f(o(S),{class:`w-6 h-6`})]),r[9]||=d(`h1`,{class:`text-3xl font-semibold tracking-tight text-foreground`},`Post not found`,-1),r[10]||=d(`p`,{class:`text-muted-foreground`},`The blog post you opened does not exist in this landing site.`,-1),d(`button`,{type:`button`,class:`inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-colors hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`,onClick:r[0]||=e=>o(y).push(`/blogs`)},` Back to blogs `)])):(i(),p(`section`,P,[d(`header`,F,[d(`div`,I,[f(o(S),{class:`w-3.5 h-3.5`}),r[1]||=e(` Memoh Blog `,-1)]),r[2]||=d(`div`,{class:`flex flex-col gap-4`},[d(`h1`,{class:`text-4xl md:text-6xl font-semibold tracking-tight text-foreground leading-[1.05]`},` Notes from the agent platform. `),d(`p`,{class:`text-base md:text-lg text-muted-foreground leading-relaxed max-w-[680px]`},` Product updates, architecture deep dives, and implementation notes from the Memoh team. `)],-1)]),D.value?(i(),m(o(_),{key:0,to:`/blogs/${D.value.slug}`,class:`group grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] overflow-hidden rounded-xl border border-border bg-background transition-all duration-300 hover:-translate-y-1 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:h(()=>[d(`div`,L,[d(`div`,R,[d(`span`,z,[f(o(b),{class:`w-3.5 h-3.5`}),e(` `+l(D.value.date),1)]),d(`span`,B,[f(o(C),{class:`w-3.5 h-3.5`}),e(` `+l(D.value.author),1)]),d(`span`,V,[f(o(x),{class:`w-3.5 h-3.5`}),e(` `+l(D.value.readingMinutes)+` min read `,1)])]),d(`div`,H,[r[3]||=d(`span`,{class:`text-xs font-medium uppercase tracking-[0.16em] text-primary`},`Latest`,-1),d(`h2`,U,l(D.value.title),1),d(`p`,W,l(D.value.excerpt),1)]),d(`span`,G,[r[4]||=e(` Read article `,-1),f(o(g),{class:`w-4 h-4 transition-transform group-hover:translate-x-0.5`})])]),r[5]||=d(`div`,{class:`border-t md:border-t-0 md:border-l border-border bg-muted/35 p-6 md:p-8 flex items-end`},[d(`div`,{class:`w-full font-mono text-xs text-muted-foreground leading-relaxed`},[d(`div`,{class:`mb-4 flex items-center gap-1.5`},[d(`span`,{class:`h-2.5 w-2.5 rounded-full bg-red-400/80`}),d(`span`,{class:`h-2.5 w-2.5 rounded-full bg-yellow-400/80`}),d(`span`,{class:`h-2.5 w-2.5 rounded-full bg-green-400/80`})]),d(`p`,null,`agent.workspace.boot()`),d(`p`,{class:`text-foreground`},`container.isolated = true`),d(`p`,null,`memory.local_first = true`),d(`p`,null,`status = "always-on"`)])],-1)]),_:1},8,[`to`])):c(``,!0),d(`section`,K,[(i(!0),p(u,null,t(o(j).slice(1),t=>(i(),m(o(_),{key:t.slug,to:`/blogs/${t.slug}`,class:`group flex min-h-[260px] flex-col justify-between rounded-xl border border-border bg-background p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:h(()=>[d(`div`,q,[d(`div`,J,[d(`span`,null,l(t.date),1),d(`span`,null,l(t.readingMinutes)+` min`,1)]),d(`div`,Y,[d(`h2`,ae,l(t.title),1),d(`p`,oe,l(t.excerpt),1)])]),d(`span`,se,[r[6]||=e(` Read article `,-1),f(o(g),{class:`w-4 h-4 transition-transform group-hover:translate-x-0.5`})])]),_:2},1032,[`to`]))),128))])]))]))}}),[[`__scopeId`,`data-v-ed316864`]]);export{Z as default};